...
• Task: Build an Intelligent Inventory Dashboard to give dealership managers a
real-time overview of their vehicle stock.
...
• Task: Build a lightweight Sales Lead Management Tool to help salespeople
manage and track incoming leads from the dealership's website.
...
• Task: Build a Unified Document Viewer to provide a single view of all
documents related to a vehicle by connecting to two different (mocked)
dealership systems.
...
• Build For the Future: Whichever layer you choose, your design and
implementation should consider scalability, performance, reliability,
